...
/** @defgroup CUSTOM_MOTION_SENSOR_EX CUSTOM MOTION SENSOR EX
  * @{
  */

/** @defgroup CUSTOM_MOTION_SENSOR_EX_Imported_Variables CUSTOM MOTION SENSOR EX Imported Variables
  * @{
  */
...
/** @defgroup CUSTOM_MOTION_SENSOR_EX_Exported_Functions CUSTOM MOTION SENSOR EX Exported Functions
  * @{
  */
