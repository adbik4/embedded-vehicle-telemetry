...
static int32_t LIS2MDL_0_Probe(uint32_t Functions)
{
  ...
  else
  {
    ...
    {
      /* The second cast (void *) is added to bypass Misra R11.3 rule */
      MotionFuncDrv[CUSTOM_LIS2MDL_0][FunctionIndex[MOTION_MAGNETO]] = (MOTION_SENSOR_FuncDrv_t *)(
...
static int32_t LSM6DSV16X_0_Probe(uint32_t Functions)
{
  ...
  io_ctx.Address     = LSM6DSV16X_I2C_ADD_H; /* SA0 = VDD */
  io_ctx.Init        = CUSTOM_LSM6DSV16X_0_I2C_Init;
  io_ctx.DeInit      = CUSTOM_LSM6DSV16X_0_I2C_DeInit;
  io_ctx.ReadReg     = CUSTOM_LSM6DSV16X_0_I2C_ReadReg;
  io_ctx.WriteReg    = CUSTOM_LSM6DSV16X_0_I2C_WriteReg;
  io_ctx.GetTick     = BSP_GetTick;
  io_ctx.Delay       = HAL_Delay;
